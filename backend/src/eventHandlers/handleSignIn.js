...
export function HandleSignIn(p) {
    var _this = this;
    p.socket.on("signIn", function (idToken) { return __awaiter(_this, void 0, void 0, function () {
        var ticket, data, googleId, newKey, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, p.oAuth2Client.verifyIdToken({
                        idToken: idToken,
                ...
                case 1:
                    ...
                    googleId = data.sub;
                    newKey = uuidv4();
                    return [4 /*yield*/, p.usersCollection.findOneAndUpdate({ googleId: googleId }, {
