...
export default function handleSocket(webSocketServer) {
    return __awaiter(this, void 0, void 0, function () {
        var date, oAuth2Client, uri, mongoClient, db, usersCollection, gameRequestsCollection, ongoingGamesCollection;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    date = new Date();
                    oAuth2Client = new OAuth2Client(process.env.GOOGLE_CLIENT_ID, process.env.GOOGLE_CLIENT_SECRET, process.env.GOOGLE_REDIRECT_URL);
                    uri = "mongodb+srv://DvirArazi:".concat(process.env.MONGODB_PASSWORD, "@cluster0.t5tdz9u.mongodb.net/?retryWrites=true");
                ...
                case 1:
                    ...
                    db = mongoClient.db("NeoChessDB");
                    usersCollection = db.collection("Users");
                    gameRequestsCollection = db.collection("GameRequests");
                    ongoingGamesCollection = db.collection("OngoingGames");
